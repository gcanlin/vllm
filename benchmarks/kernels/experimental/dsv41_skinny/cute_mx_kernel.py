...
def fused_ue8m0_scale(sa_packed, sb_packed, byte_idx, *, loc=None, ip=None):
    ...
    res = _llvm.inline_asm(
        ...
        [val_a, val_b, idx],
        "{"
        ".reg .u32 ea, eb, combined, exponent, bitpos, subnormal;"
        ".reg .pred is_subnormal, representable, overflow, nan_a, nan_b, is_nan;"
        "prmt.b32 ea, $1, 0, $3;"
        "and.b32 ea, ea, 0xFF;"
        "prmt.b32 eb, $2, 0, $3;"
        "and.b32 eb, eb, 0xFF;"
        "add.u32 exponent, ea, eb;"
        "sub.u32 exponent, exponent, 127;"
        "shl.b32 combined, exponent, 23;"
        "add.s32 bitpos, exponent, 22;"
        "shl.b32 subnormal, 1, bitpos;"
        "setp.ge.s32 representable, bitpos, 0;"
        "selp.u32 subnormal, subnormal, 0, representable;"
        "setp.le.s32 is_subnormal, exponent, 0;"
        "selp.u32 combined, subnormal, combined, is_subnormal;"
        "setp.ge.s32 overflow, exponent, 255;"
        "selp.u32 combined, 0x7f800000, combined, overflow;"
        "setp.eq.u32 nan_a, ea, 255;"
        "setp.eq.u32 nan_b, eb, 255;"
        "or.pred is_nan, nan_a, nan_b;"
        "selp.u32 combined, 0x7fffffff, combined, is_nan;"
        "mov.b32 $0, combined;"
        "}",
        "=f,r,r,r",
...
class LLFp8BlockGemm:
    ...
    def __init__(
        ...
        self.copy_bits = 128
        self.scale_group_size = 32
        self.scales_per_packed = 4
        self.k_blocks_per_scale = 1
