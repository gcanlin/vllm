...
if TYPE_CHECKING:
    ...
    VLLM_KIMI_K3_ROUTED_DOWN_MXFP8: bool = True
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Fuse Kimi-K3's BF16 routed down projection with non-swizzled MXFP8.
    "VLLM_KIMI_K3_ROUTED_DOWN_MXFP8": lambda: bool(
        int(os.getenv("VLLM_KIMI_K3_ROUTED_DOWN_MXFP8", "1"))
    ),
